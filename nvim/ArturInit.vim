"NeoBundle Scripts-----------------------------
set runtimepath+=/Users/volodymyrgula/.config/nvim/bundle/neobundle.vim/

" Required:
call neobundle#begin(expand('/Users/volodymyrgula/.config/nvim/bundle'))
...
let g:EasyGrepFilesToExclude='*.swp,*~,*.beam,*.log,_build/,node_modules,erl_crash.dump,tmp,*webpack_bundle.js'
" let g:EasyGrepFilesToExclude='tmp,assets,log'
